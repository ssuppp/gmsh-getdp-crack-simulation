Function {
    ...
    // ------- Superconductor constitutive law (Normal Tape) -------
    ec = 1e-4;
    epsSigma = 1e-8; // Regularization parameters
    epsSigma2 = 1e-15;
    ...
    // ------- Superconductor constitutive law (Crack / Weak Region) -------
    If(Flag_jcb == 1)
...
Function{
    ...
    // CrackSuper (HTS with crack power law)
