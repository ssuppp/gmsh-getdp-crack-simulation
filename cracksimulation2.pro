...
// ==========================================
// 10. POST-OPERATION (UPDATED FOR EDGE CRACK)
// ==========================================
PostOperation {
  { Name Map; NameOfPostProcessing Magnetics_H;
    Operation {
      Print[b,            OnElementsOf Domain_Total, File "b_edge_crack.msh"];
      Print[normb,        OnElementsOf Domain_Total, File "normb_edge_crack.msh"];
      Print[j,            OnElementsOf HTS,          File "j_edge_crack.msh"];
      Print[normj,        OnElementsOf HTS,          File "normj_edge_crack.msh"];
      Print[PowerDensity, OnElementsOf HTS,          File "power_edge_crack.msh"];
      
      Print[Loss_HTS[HTS], OnGlobal,                 File "loss_vs_time_edge_crack.gvl", Format Table];
    }
  }
}
